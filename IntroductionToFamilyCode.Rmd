...
```{r}
proBound_runDIR <- 'results_for_publication/'
...
```{r}
BaseLines <- getBaseLineAccuracy(mono_motifs, pos = 'P-1', randomSample = F)
...
SELEXFile_Template <- 'E:/Desktop/RM_Rotation_3/SELEX_12212022/$modelFile$/fit.models.consensus.json'
